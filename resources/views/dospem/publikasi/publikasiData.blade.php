                    ...
                    <div class="card-body">
                        <table id="data1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($dt->status_post == 2)
                                        <a href="{{ url('/dosen/publikasi/edit/'.$dt->id.'')}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                        <a href="{{ url('/dosen/publikasi/delete/'.$dt->id.'')}}" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                                    @else
