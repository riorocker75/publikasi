...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">Unggah Laporan Akhir</h4>
            </div><!-- /.col -->
            <div class="col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                @endforeach
                <form role="form" action="{{url('/mahasiswa/daftar-usulan/unggah-akhir/act')}}" enctype="multipart/form-data" method="post">
                    {{ csrf_field() }}
                  <div class="card-body">  
                      <div class="row">
                        <div class="col-lg-12 col-12">
                                ...
                                <div class="form-group">
                                    <label for="avatar">Laporan Akhir (.pdf) </label>
