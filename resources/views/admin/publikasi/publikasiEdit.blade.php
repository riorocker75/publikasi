...
<!-- /.content-header -->
    ...
    <section class="content">
        ...
        @endforeach
        <form action="{{url('/admin/publikasi/update')}}" enctype="multipart/form-data" method="post">
            {{ csrf_field() }}
            <div class="row">  
                <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" name="judul"  placeholder="Judul Publikasi" value="{{$dt->judul}}" disabled>
                              @if($errors->has('judul'))
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                             ...
                             <textarea name="deskripsi" cols="100" rows="5" disabled>{{$dt->deskripsi}}</textarea>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                              <input type="date" class="form-control" name="tgl"  value="{{$dt->tgl}}" disabled>
                              @if($errors->has('tgl'))
                              <small class="text-muted text-danger">
                                  {{ $errors->first('tgl')}}
                                  </small>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" name="kunci" value="{{$dt->kata_kunci}}" disabled>
                              @if($errors->has('kunci'))
                              <small class="text-muted text-danger">
                                  {{ $errors->first('kunci')}}
                                  </small>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <select class="form-control" name="status_berkas" disabled>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="avatar">File Jurnal</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" name="link" value="{{$dt->link}}" disabled>
                              @if($errors->has('link'))
                              <small class="text-muted text-danger">
                                  {{ $errors->first('link')}}
                                  </small>
                          ...
                          <input type="submit" class="btn btn-primary" name="terima" value="Publish">
